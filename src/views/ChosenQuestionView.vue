    ...
    <div id="game-card-wrapper">
        ...
        <div id="question-card">
            ...
            <button
                ...
                class="answer-choice"
                :disabled="isDisabled || userStorage.isTimeOut"
            >
        ...
        <div
            ...
            v-show="selectedAnswer !== null && !isGameEnded"
        >
            ...
            <div class="next-btn">
                <RouterLink to="/game">
                    <CustomButton>Nästa fråga</CustomButton>
                </RouterLink>
            </div>
        </div>
        ...
        <div id="result-wrapper" v-show="isGameEnded">
            <RouterLink to="/game/result">
                <CustomButton>Resultat</CustomButton>
            </RouterLink>
            <div class="firework" />
        </div>
    </div>
